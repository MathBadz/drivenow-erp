...
onMounted(() => {
    // Collapse the off-canvas drawer by default on small screens.
...
<template>
    <div class="flex h-screen w-full overflow-hidden bg-background">
        ...
        <div class="flex min-w-0 flex-1 flex-col">
            <!-- Topbar -->
            <header
                class="sticky top-0 z-20 flex h-16 shrink-0 items-center gap-3 border-b border-border bg-card/80 px-4 backdrop-blur-sm"
            >
                <button
                    type="button"
                ...
                <div class="ml-auto flex items-center gap-2">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger as-child>
                            <button
                                type="button"
                                class="flex items-center gap-2 rounded-lg border border-border py-1 pr-2 pl-1 transition-colors hover:border-amber-300"
                            >
                                <UserInfo :user="user" />
                            </button>
                        </DropdownMenuTrigger>
